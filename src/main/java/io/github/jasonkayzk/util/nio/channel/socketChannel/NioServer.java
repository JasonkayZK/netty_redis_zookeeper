...
public class NioServer {
    ...
    private ByteBuffer buffer = ByteBuffer.allocate(DemoConfig.SERVER_BUFFER_SIZE);
    ...
    public void startServer() throws IOException {
        ...
        // 4、绑定连接
        serverSocket.bind(new InetSocketAddress(DemoConfig.SOCKET_SERVER_PORT));
        ...
        try {
            ...
            while ((num = socketChannel.read(buffer)) > 0) {
                ...
                if (null == client.fileName) {
                    ...
                    String destPath = IOUtil.getResourcePath(DemoConfig.SOCKET_RECEIVE_PATH);
